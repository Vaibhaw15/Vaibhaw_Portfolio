...
interface AnimatedWorkExperienceCardProps {
  experience: WorkExperienceItem;
  index: number;
}

export default function AnimatedWorkExperienceCard({ experience, index }: AnimatedWorkExperienceCardProps) {
      ...
      <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
        <CardHeader>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            ...
            <Badge variant="secondary" className="text-xs whitespace-nowrap">{experience.dateRange}</Badge>
          </div>
